...
const contactInfo = [
  {
    icon: MapPin,
    title: "Address",
    content: "First Floor, Petrol Pump, Celebration palace, near City Station Bridge, opp. Rifa e aam club, Wazirganj, Lucknow, Uttar Pradesh 226018",
  },
  {
    icon: Phone,
    title: "Contact details",
    content: "+919619887358",
  },
  {
    icon: Mail,
    title: "Email",
    content: "info@optimumfitnessgym.com",
  },
  {
    icon: Clock,
    title: "Hours",
          ...
          <div>
            ...
            <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-6">
              ...
              <p className="text-neutral-400 text-sm">
                Not sure if Optimum Fitness Gym is right for you? Sign up for a free 3-day trial and experience our facilities
                firsthand.
              </p>
            </div>
          </div>
